                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-section">
                            ...
                            <h4 class="text-section">Colleges</h4>
                        </li>
                        <li class="nav-item">
                            <a data-bs-toggle="collapse" href="#college">
                                <i class="fa-solid fa-building-columns"></i>
                                <p class="px-2">College Management</p>
                                <span class="caret"></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a data-bs-toggle="collapse" href="#students">
                                ...
                                <p class="px-2">Student Management</p>
                                <span class="caret"></span>
                            </a>
